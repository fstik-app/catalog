...
var _lottie_init = (Module['_lottie_init'] = function () {
  return (_lottie_init = Module['_lottie_init'] = Module['asm']['D']).apply(
    null,
    arguments
  );
});
var _lottie_resize = (Module['_lottie_resize'] = function () {
  return (_lottie_resize = Module['_lottie_resize'] = Module['asm']['E']).apply(
    null,
    arguments
  );
});
...
var _lottie_load_from_data = (Module['_lottie_load_from_data'] = function () {
  return (_lottie_load_from_data = Module['_lottie_load_from_data'] =
    Module['asm']['G']).apply(null, arguments);
});
var _lottie_buffer = (Module['_lottie_buffer'] = function () {
  return (_lottie_buffer = Module['_lottie_buffer'] = Module['asm']['H']).apply(
    null,
    arguments
  );
});
var _lottie_destroy = (Module['_lottie_destroy'] = function () {
  return (_lottie_destroy = Module['_lottie_destroy'] =
    Module['asm']['I']).apply(null, arguments);
});
var _lottie_render = (Module['_lottie_render'] = function () {
  return (_lottie_render = Module['_lottie_render'] = Module['asm']['J']).apply(
    null,
    arguments
  );
});
...
var _realloc = (Module['_realloc'] = function () {
  return (_realloc = Module['_realloc'] = Module['asm']['L']).apply(
    null,
    arguments
  );
});
...
var _setThrew = (Module['_setThrew'] = function () {
  return (_setThrew = Module['_setThrew'] = Module['asm']['N']).apply(
    null,
    arguments
  );
});
...
var dynCall_iii = (Module['dynCall_iii'] = function () {
  return (dynCall_iii = Module['dynCall_iii'] = Module['asm']['P']).apply(
    null,
    arguments
  );
});
var stackSave = (Module['stackSave'] = function () {
  return (stackSave = Module['stackSave'] = Module['asm']['Q']).apply(
    null,
    arguments
  );
});
var stackAlloc = (Module['stackAlloc'] = function () {
  return (stackAlloc = Module['stackAlloc'] = Module['asm']['R']).apply(
    null,
    arguments
  );
});
var stackRestore = (Module['stackRestore'] = function () {
  return (stackRestore = Module['stackRestore'] = Module['asm']['S']).apply(
    null,
    arguments
  );
});
var dynCall_v = (Module['dynCall_v'] = function () {
  return (dynCall_v = Module['dynCall_v'] = Module['asm']['T']).apply(
    null,
    arguments
  );
});
